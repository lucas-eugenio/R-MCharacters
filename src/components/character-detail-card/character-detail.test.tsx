...
it("Renders Avatar Img, Name, Species, Gender, Status, Origin, Location And Episodes List", () => {
  render(<CharacterDetailCard character={character} />);
  ...
  const originElement = screen.getByText(character.origin.name);
  ...
  expect(listItemElements.length).toBe(51);
});
